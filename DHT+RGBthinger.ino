 ...
 * This code uses the iBHubs IoT HDK(with ESP8266) to input humidity and temperature vals from DHT11 module and upload to thinger.io. 
...
#define DEVICE_CREDENTIAL "bBFCtrUTeyi4"
